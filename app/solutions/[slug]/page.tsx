...
export async function generateStaticParams() {
    return erpSolutions.map((solution) => ({
        slug: solution.id,
    }));
}
...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
    ...
    const solution = erpSolutions.find((s) => s.id === slug);
    if (!solution) {
        return {
                ...
                <div className="bg-card border border-border rounded-3xl overflow-hidden shadow-xl">
                    <div className="h-64 md:h-80 relative overflow-hidden">
                        ...
                        <div className="absolute bottom-0 left-0 p-8 md:p-12 z-20">
                            ...
                            <h1 className="text-4xl md:text-6xl font-bold text-white shadow-sm">{solution.title}</h1>
                        </div>
                    </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
                            ...
                            <div className="bg-accent/5 p-8 rounded-2xl border border-border/50">
                                ...
                                <p className="text-muted-foreground mb-6">
                                    Discover how our {solution.title} can drive efficiency and growth for your organization.
                                </p>
                                <Link href="/contact">
