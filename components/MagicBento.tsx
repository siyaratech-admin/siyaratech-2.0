              ...
              return (
                ...
                >
                  ...
                  <div className="card__content flex flex-col relative text-white z-10 mt-auto">
                    <h3 className={`card__title font-bold text-xl m-0 mb-2 drop-shadow-lg ${textAutoHide ? 'text-clamp-1' : ''}`}>
                      {card.title}
                    </h3>
                    <p
                      className={`card__description text-sm leading-relaxed opacity-90 drop-shadow-md ${textAutoHide ? 'text-clamp-2' : ''}`}
                    >
                      {card.description}
                    </p>
                  </div>
