...
export default function InnovatingSection() {
    return (
        <section className="py-24 relative overflow-hidden bg-background">
            <SectionLightRay segmentStart={0} segmentEnd={0.125} />
                    ...
                    >
                        <div className="relative rounded-3xl border border-white/10 bg-white/5 backdrop-blur-md p-8 md:p-10 shadow-2xl overflow-hidden group">
                            ...
                            <div className="relative space-y-6 text-lg text-muted-foreground leading-relaxed">
                                ...
                                <p>
                                    We are dedicated to empowering organizations through{" "}
                                    <span className="text-foreground font-medium bg-clip-text text-transparent bg-gradient-to-r from-brand-purple to-brand-orange">
                                        Artificial Intelligence, Machine Learning, and robust Cloud Infrastructure
                                    </span>
