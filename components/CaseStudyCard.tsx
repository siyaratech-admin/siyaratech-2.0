...
export default function CaseStudyCard({
  ...
  return (
    <motion.div
      ...
      className="h-full"
    >
      <Link href={`/case-studies/${slug}`} className="block h-full cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary rounded-xl">
        <Card
          className="group relative h-full overflow-hidden border-border/40 bg-card/50 backdrop-blur-sm hover:border-primary/50 hover:shadow-2xl transition-all duration-300 flex flex-col"
        >
          ...
          <CardContent className="p-6 flex flex-col flex-grow relative z-10">
            ...
            <div className="mt-auto pt-2">
              <Button
                variant="default"
                size="sm"
                className="w-full justify-between group/btn bg-primary/90 hover:bg-primary shadow-md hover:shadow-primary/20 transition-all duration-300 pointer-events-none"
                asChild
              >
                <span>
