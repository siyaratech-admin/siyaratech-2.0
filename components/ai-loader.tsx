...
export const Component: React.FC<LoaderProps> = ({ size = 180, text = "Generating" }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gradient-to-b from-[#833AB4]/50 via-[#FD1D1D]/50 to-black dark:from-gray-100 dark:via-gray-200 dark:to-gray-300">
      <div
